//
//  RNIAdaptiveModalCommandConfigSnapTo.swift
...
struct RNIAdaptiveModalCommandConfigSnapTo: InitializableFromDictionary {
  
  var mode: RNIAdaptiveModalCommandConfigSnapToMode;
